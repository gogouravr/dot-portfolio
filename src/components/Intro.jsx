...
export default function Intro() {
    ...
    return (
        <section className="flex flex-col justify-center mt-2 sm:mt-15 mx-auto w-11/12 sm:w-10/12 md:w-9/12 lg:w-8/12">
            <div className="text-slate-900 dark:text-sky-500 font-[1] font-normal mt-20 mb-2 text-base sm:text-lg md:text-2xl tracking-tighter">
                👋 Hi, my name is
            </div>

            <h2 className="text-sky-500 dark:text-slate-300 font-semibold font-high-l dark:opacity-90 leading-15 text-4xl sm:text-5xl md:text-6xl">
                {profile['first-name'] + ' ' + profile['last-name'] + '.'}
            </h2>

            <p className="text-slate-700 dark:text-white font-high-l font-bold mt-3 text-4 dark:opacity-50 leading-tight text-4xl sm:text-6xl md:text-6xl">
                {profile.intros[0] + '.'}
            </p>
            ...
            <p className='text-slate-900 dark:text-white font-light dark:font-thin font-sans dark:opacity-82 w-3/4 my-6 lg:w-9/12 text-base sm:text-base md:text-[1.29rem] tracking-wide' >
                {profile.bio[0]}
                <a href="https://www.faeththerapeutics.com/" target='_blank' rel='noreferrer' className="font-light font-normal rounded text-sky-500 focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-sky-400">
                    {profile.bio[1]}
                </a>
                {profile.bio[2]}
            </p>
