...
export default function Experience() {
    return (
        <div className='flex flex-col items-center md:items-end  my-20 sm:mt-10 md:mt-40 lg:mt-60 mx-auto w-11/12 sm:w-10/12 md:w-9/12 lg:w-8/12' id='experience'>
            ...
            <section className='font-sans font-[240] lg:w-2/3 opacity-80 mt-5 text-white text-base lg:text-[1.1rem] tracking-tight'>
                {profile['experience'].map(organisation =>
                    <div>
                        ...
                        <h4 className='text-base md:text-xl font-normal'>{organisation['role']}</h4>
