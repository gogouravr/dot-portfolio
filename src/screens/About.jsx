...
export default function About() {
    return (
        <div className='my-20 a sm:mt-10 md:mt-40 lg:mt-60 mx-auto w-11/12 sm:w-10/12 md:w-9/12 lg:w-8/12' id='about'>
            <h2 className='text-white font-medium text-2xl font-high-l text-center lg:text-start lg:self-start lg:ml-[33.3%] lg:text-3xl opacity-70'>
            ...
            <section className='flex flex-col lg:flex-row mx-auto lg:justify-between items-center lg:items-start mt-8 sm:mt-5 w-fit'>
                ...
                <p className='font-high-l font-[280] leading-6 lg:w-2/3 opacity-80 mt-8 lg:mt-5 text-white text-base lg:text-[1.1rem] tracking-tight flex flex-col gap-3'>
