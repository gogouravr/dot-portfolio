...
export default function About() {
    return (
        <div className='dark:text-white text-slate-900 my-20 a sm:mt-10 md:mt-40 lg:mt-60 mx-auto w-11/12 sm:w-10/12 md:w-9/12 lg:w-8/12' id='about'>
            <h2 className='dark:text-white text-sky-900 font-medium text-2xl font-high-l text-center lg:text-start lg:self-start lg:ml-[33.3%] lg:text-3xl dark:opacity-80'>
            ...
            <section className='flex flex-col lg:flex-row mx-auto lg:justify-between items-center lg:items-start mt-8 sm:mt-5 w-fit'>
                ...
                <figure className='mt-10 w-3/4 max-w-[300px] lg:w-[25%] lg:max-w-none image-container relative rounded-full'>
                    <img className='border-3 shadow-[0_0_20px_20px_rgba(14,165,233,0.80)] border-sky-500 dark:opacity-80 opacity-95 rounded-full drop-shadow-2xl dark:bg-slate-800 bg-sky-200' src="/gourav-raj-photo.png" alt={profile['first-name'] + ' ' + profile['last-name']} />
                </figure>

                <p className='font-high-l dark:font-[280] font-[399] leading-6 lg:w-2/3 dark:opacity-80 mt-8 lg:mt-5 text-base lg:text-[1.1rem] tracking-normal flex flex-col gap-3'>
